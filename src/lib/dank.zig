...
pub const Dank = struct {
    writer: *std.Io.Writer,
    allocator: std.mem.Allocator,
    tree: *treenest.TreeNest,

    const Self = @This();

    pub fn withTree(allocator: std.mem.Allocator, tree: *treenest.TreeNest) Self {
        return .{
            .writer = tree.writer,
            .allocator = allocator,
            .tree = tree,
    ...
    pub fn compose(self: Self, parts: []const Part) treenest.TreeNest.LineComposer {
